#' CircadianRNASeq: statistical models, data, and functions for analyzing temporal gene expression over the 24-hour day

#' This package is related to Yeung, Mermet et al. 2018 Genome Research (https://europepmc.org/article/pmc/5793782)

#' ## Installation instructions to install data and functions developed and used in Yeung 2018
#' 
